...
<!--                                         
                                        ...
                                        <!-- <div class="form-group">
                                            <label class="control-label col-lg-4">Processor/Type/Flavour</label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">Internal Memory/Manufactured date </label>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-4">RAM/Expiration date</label>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="">
                                                 ...
                                                 <textarea id="wysihtml5" class="form-control" rows="9" cols="35" name="Description"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
