...
<div class="widget purple">
                         ...
                         <div class="widget-body">
                             <div class="row-fluid">
                              ...
                              <?php   
	$idd=$_GET['id'];
	$result = mysqli_query($db,"SELECT * FROM sales WHERE IDInvoice='$idd'");
  ...
  ?>
                                         ...
                                         <td><?php echo $product['QuantitySold'];?></td>
                                          <td>GH₵<?php echo $product['Price'];?></td>
                                           <td>GH₵<?php echo $product['TotalPrice'];?></td>
                                     </tr>
                              			 <?php } ?>
                                     <tr>
                                       <td>&nbsp;</td>
                             ...
                             <div class="row-fluid">
								 ...
								 ?>
                                         ...
                                         <p style="padding:10px; margin-bottom:5px; background:#f1f1f1"><strong>VAT :</strong> GH₵<?php echo $VAT ?></p>
                                         <p style="padding:10px; margin-bottom:5px; background:#f1f1f1"><strong>Grand Total :</strong>GH₵<?php echo $GrandTotal ?></p>
                                    	 <p style="padding:10px; margin-bottom:5px; background:#f1f1f1"><strong>Amount Paid :</strong> GH₵<?php echo $PaidAmount ?></p>
                                         <p style="padding:10px; margin-bottom:5px; background:#f1f1f1"><strong>Balance :</strong>GH₵<?php echo $Rest ?></p>
