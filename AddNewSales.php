...
<body class="padTop53 ">
 ...
 <?php
      ...
      $query= mysqli_query($db,"SELECT * FROM price where IDProduct='$idd'");
 ...
 ?> 
                                ...
                                <!-- <span class="input-group-addon add-on" data-toggle="modal" data-target="#NewInvoiceNumber"><i class=" icon-plus"></i></span> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4 ">
                                              <input type="text" id="Price" name="Price" class="form-control" value="<?php echo $pricing; ?>" readonly />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="ClientPhone" name="ClientPhone" class="form-control" data-mask="+233 999 999 999"/>
